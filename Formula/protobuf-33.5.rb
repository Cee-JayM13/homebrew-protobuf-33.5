class Protobuf33.5 < Formula
  ...
  bottle do
    # No pre-built bottle for 33.5 in this custom formula — it will build from source (fast on M1)
    # You can safely leave this empty or delete the whole bottle block
  end
